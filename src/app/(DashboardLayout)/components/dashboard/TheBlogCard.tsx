...
const BlogCard = () => {
  return (
    <Card variant="outlined" sx={{ p: 0 }}>
      <CardMedia
        sx={{ height: 220 }}
        image="https://teacode.io/wp-content/uploads/2022/06/Copy-of-AWS-Amplify-blog-compress.png"
        title="green iguana"
      />
      <CardContent>
        <Stack direction="row" alignItems="center" spacing={1} mb={2}>
          <IconClock width={20} />
          <Typography variant="h6">22 May, 2024</Typography>
        </Stack>
        <Typography variant="h5">
          Latest Learing : Learned Basics of NEXT.JS
        </Typography>
